    ...
    steps: [
      {
        ...
        ingredients: ["1 tsp salt", "2 tsp baking soda", "1 pound beef"],
      },
      {
        title: "Prepare Sauce",
        time: "1",
        content: `Serve with cold water.`,
        ingredients: ["1 quart chicken stock", "1 chicken sandwich", "10 carrots"],
      },
    ],
  };
    ...
    <>
      ...
      <div className="recipe-container">
        ...
        <div className="directions-container">
          {data.steps.map((step, number) => (
            <DirectionStep
              toggleStep={toggleActiveStep}
              key={`step-${number}`}
              {...step}
              number={number}
            />
